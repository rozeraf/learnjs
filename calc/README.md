...
**Цель:** Практическое применение функций, условий и пользовательского ввода для
создания интерактивной консольной программы.
...
- **`isNaN()`:** Проверка, является ли результат преобразования `NaN`
  (Not-a-Number).
